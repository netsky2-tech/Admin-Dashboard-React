        ...
        <div className='flex m-3 flex-wrap justify-center gap-1 items-center'>
          {earningData.map((item) => (
            <div key={item.title} className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56 p-4 pt-9 rounded-2xl">
              ...
              <p className='textsm text-gray-400 mt-1'>{item.title}</p>
            </div>
          ))}
        </div>
      </div>

      {/*Reveneu updates card*/}
        ...
        <div className='bg-white dark:text-gra-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780'>
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            <div className='border-r-1 border-color m-4 pr-10'>
              <div>
                <p>
                  <span className='text-3xl font-semibold'>$93,485</span>
              ...
              <div className='mt-8'>
                <p>
                  <span className='text-3xl font-semibold'>$45,485</span>
                </p>
